...
--
-- Host: 127.0.0.1
-- Tempo de geração: 07/02/2026 às 21:49
...
(1, '2025-10-10 14:00:00', 'Agendado', 1, 1, '2026-02-07 20:03:22', '2026-02-07 20:03:22'),
(2, '2025-10-11 10:00:00', 'Agendado', 1, 2, '2026-02-07 20:03:22', '2026-02-07 20:03:22');
...
(1, 'Corte Feminino', 'Corte e finalização', 50.00, '00:30:00', 1, 1),
(2, 'Manicure', 'Manicure completa', 35.00, '00:45:00', 2, 2),
...
ALTER TABLE `escalas`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_prof_dia_inicio` (`id_profissional_fk`,`dia_semana`,`inicio`),
  ADD KEY `id_profissional_fk` (`id_profissional_fk`),
